...
locals { 
  ...
  request_routing_rule1_name_app1     = "${azurerm_virtual_network.vnet.name}-rqrt-1-app1"
  ...
  request_routing_rule1_name_app2     = "${azurerm_virtual_network.vnet.name}-rqrt-1-app2"
...
# Listener: HTTP Port 80 with app1.terraformguru.com
  http_listener {
...
# Listener: HTTP Port 80 with app2.terraformguru.com
  http_listener {
...
# Routing Rule - app1.terraformguru.com
  request_routing_rule {
    name = local.request_routing_rule1_name_app1
    rule_type = "Basic"
...
# Routing Rule - app2.terraformguru.com
  request_routing_rule {
    name = local.request_routing_rule1_name_app2
    rule_type = "Basic"
